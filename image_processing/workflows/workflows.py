...
class OrganoidMipProcessingWorkflow():
    ...
    def run(self):
        ...
        # Define parameters used to segment
        segmentation_parameters = pd.DataFrame([
        {'barcode': '180823UM1f2', 'segmentation_method': WatershedSegmentation(), 'network': None,
             'area': (1000, 1200000), 'circularity': (0.0, 1), 'solidity': (0.6, 1.0), 'aspect_ratio': 3, 'channel': 4},
        {'barcode': '180823UM1f4', 'segmentation_method': NeuralNetworkSegmentationMIP(), 'network': 'v_3',
         'area': (10000, 1200000), 'circularity': (0.0, 1), 'solidity': (0.6, 1.0), 'aspect_ratio': 3, 'channel': 4}])
